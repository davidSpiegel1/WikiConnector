...
try:
    ...
    prinself.search_bar.move(
                    (self.width() - self.search_bar.width()) // 2,  # Center horizontally
                    (self.height() - self.search_bar.height()) // 2  # Center vertically
                )t("tkhtmlview not found. Using pip to install")
